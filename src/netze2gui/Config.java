...
public class Config
{
    ...
    public static final Rule[] Switch_A_rules = {
            ...
            new Rule("A:r2", true, Link_AB, Terminal_B), //false = A:r2, B:r2 mit Reserved
            new Rule("A:r3", false, Link_AC, Terminal_C) //false = A:r3 ohne Reserved
    };
    ...
    public static final Rule[] Switch_C_rules = {
            new Rule("C:r1", true, Link_AC, Terminal_A, Terminal_B), //false = C:r1 ohne Reserved

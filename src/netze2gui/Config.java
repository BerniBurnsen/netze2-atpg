...
public class Config
{
    ...
    public static final Rule[] Switch_A_rules = {
            ...
            new Rule("A:r2", true, Link_AB, Terminal_B), //false = A:r2  //TODO: !!! MIT RESERVED !!!
            new Rule("A:r3", true, Link_AC, Terminal_C) //false = A:r3  //TODO: !!! OHNE RESERVED !!!
    };
    ...
    public static final Rule[] Switch_C_rules = {
            new Rule("C:r1", true, ruleC, Terminal_A, Terminal_B), //false = C:r1 //TODO: !!! OHNE RESERVED !!!
            new Rule("C:r2", true, Terminal_C, Terminal_C) //false = A:r3, B:r3, C:r2 mit Reserved
    };
